...
/**
 * This class encapsulates a Maybe Object.
 * CS2030S Lab 7 
 * AY22/23 Semester 2
 *
...
public abstract class Maybe<T> {
   ...
   *
   * @param <T> Type parameter T of the object containined.
   *
   ...
   *
   * @param <T> Type parameter T of the object contained.
   *
   ...
   *
   * @param <U>         Type parameter U of the object contained, returned.
   *
  ...
  private static class None extends Maybe<Object> {
    ...
    @Override
    public <U> Maybe<U> 
        flatMap(Transformer<? super Object, ? extends Maybe<? extends U>> transformer) {
      return Maybe.none();
    }
  ...
  /**
   * This class encapsulates a Some object.
   */
