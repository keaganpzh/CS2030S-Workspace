...
public class Main {
  ...
  public static void main(String[] args) {
    // made start final due to checkstyle.
    ...
    CompletableFuture<?>[] allRoutes = routes.toArray(new CompletableFuture<?>[routes.size()]);
    CompletableFuture.allOf(allRoutes).join();
    for (CompletableFuture<?> cf : allRoutes) {
