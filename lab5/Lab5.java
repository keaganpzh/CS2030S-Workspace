  ...
  public static String getGrade(String student, String module, String assessment,
    ...
    Transformer<Map<String, Map<String, String>>, Maybe<Map<String, String>>> getModule = 
        new Transformer<Map<String, Map<String, String>>, Maybe<Map<String, String>>>() {
          public Maybe<Map<String, String>> transform(Map<String, Map<String, String>> item) {
            return Maybe.of(item.get(module));
          }
        };

    Transformer<Map<String, String>, Maybe<String>> getAssessment = 
        new Transformer<Map<String, String>, Maybe<String>>() {
          public Maybe<String> transform(Map<String, String> item) {
            return Maybe.of(item.get(assessment));
          }
        };

    return Maybe.of(map.get(student)).flatMap(getModule).flatMap(getAssessment)
      .orElse("No such entry").toString();
  }
